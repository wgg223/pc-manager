...
- **纾佺洏娓呯悊**: 娓呯悊涓存椂鏂囦欢銆佺郴缁熺紦瀛樺拰鍥炴敹绔?- **绯荤粺淇℃伅**: 鏌ョ湅 CPU銆佸唴瀛樸€佺鐩樹娇鐢ㄦ儏鍐?- **杩涚▼绠＄悊**: 鏌ョ湅鍜岀鐞嗙郴缁熻繍琛岃繘绋?- **鍚姩椤圭鐞?*: 绠＄悊寮€鏈鸿嚜鍚姩绋嬪簭
...
## 寮€鍙戞ā寮忚繍琛?
```bash
npm run dev          # 浠呭惎鍔ㄥ墠绔紑鍙戞湇鍔″櫒
npm run electron:dev # 鍚屾椂鍚姩鍓嶇鍜?Electron
```
